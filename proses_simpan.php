...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($db, "SELECT nim FROM tbl_mahasiswa WHERE nim='$nim'")
    ...
    // jika nim belum ada
        ...
        if(move_uploaded_file($tmp_file, $path)) {
            ...
            $insert = mysqli_query($db, "INSERT INTO tbl_mahasiswa(nim,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,agama,alamat,no_hp,foto)
