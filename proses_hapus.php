...
if (isset($_GET['nim'])) {
    ...
    $query = mysqli_query($db, "SELECT foto FROM tbl_mahasiswa WHERE nim='$nim'") 
    ...
    // cek hapus file
    if ($hapus_file) {
        // jika file berhasil dihapus jalankan perintah query untuk menghapus data pada tabel mahasiswa
        $delete =mysqli_query($db, "DELETE FROM tbl_mahasiswa WHERE nim='$nim'") 
