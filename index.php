...
<html lang="en">
  	<head>
	    ...
	    <meta name="author" content="Arip Rahmat Hakim">
		
		<!-- favicon -->
    	<link rel="shortcut icon" href="assets/img/toga.png">
	    <!-- Bootstrap CSS -->
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        &copy; 2019 - <a class="text-info" href="https://kenaristudio.id/">kenaristudio.id</a>
                    </div>
                </div>
            </footer>
        </div>
