    ...
    ?>  
        ...
        <table class="table table-striped table-bordered">
            ...
            if (isset($cari)) {
                ...
                $query_jumlah = mysqli_query($db, "SELECT count(nim) as jumlah FROM tbl_mahasiswa WHERE nim LIKE '%$cari%' OR nama LIKE '%$cari%'")
            ...
            // jika tidak dilakukan pencarian data
                ...
                $query_jumlah = mysqli_query($db, "SELECT count(nim) as jumlah FROM tbl_mahasiswa")
                                                   or die('Ada kesalahan pada query jumlah_record: '.mysqli_error($db));
            }
            ...
            if (isset($cari)) {
                ...
                $query = mysqli_query($db, "SELECT * FROM tbl_mahasiswa WHERE nim LIKE '%$cari%' OR nama LIKE '%$cari%'  ORDER BY nim DESC LIMIT $mulai, $batas") 
            ...
            // jika tidak dilakukan pencarian data
                ...
                // data yang ditampilkan mulai = $mulai sampai dengan batas = $batas
                $query = mysqli_query($db, "SELECT * FROM tbl_mahasiswa ORDER BY nim DESC LIMIT $mulai, $batas")
                                            or die('Ada kesalahan pada query siswa: '.mysqli_error($db));
            }
            // tampilkan data
